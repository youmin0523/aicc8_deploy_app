...
- **v1.4_20260219**: 일정(Schedule) 모듈 설계 및 구현 완료 (Done)
  - **[Back]**: `private_schedules` 테이블 정의 및 CRUD 컨트롤러 추가.
  - **[Front]**: `ScheduleTab.jsx` 컴포넌트 신규 생성 및 7대 입력 필드 구현.
  - **[Front]**: 파일 업로드 로직 및 UI 인터랙션 강화.
